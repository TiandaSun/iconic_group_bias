...
# =============================================================================
# VLM Evaluation Pipeline: Gemini-2.5-Flash (API)
...
# API Key
export GOOGLE_API_KEY="${GOOGLE_API_KEY:?Set GOOGLE_API_KEY in your environment before submitting.}"
